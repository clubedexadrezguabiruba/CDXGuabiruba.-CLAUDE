...
export const AVATAR_ASSETS: readonly string[] = [
  ...
  "/items/hand/cetro-rainha.png",
  "/items/hand/cetro-rei.png",
  "/items/hand/escudo-torre.png",
  "/items/hand/espada-peao.png",
  "/items/hand/livro-gambitos.png",
  "/items/hand/orbe-sabedoria.png",
  "/items/hand/peao-madeira.png",
  "/items/hand/relogio-simples.png",
