-- ============================================================
-- Canonical definition of puzzle_attempt()
--
-- Previous migrations (180300, 000100, 000300, 000400) each
-- redefined this function. This migration is the single
-- source of truth going forward. Any future changes to
-- puzzle_attempt should be made here or via a new migration
