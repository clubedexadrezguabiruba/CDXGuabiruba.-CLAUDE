-- ============================================================
-- FASE 5 — SEED: Aula Piloto "A Torre — Movimento e Captura"
-- Recruta, trail_order=3, 4 exercícios
-- Todos os FENs e lances validados com chess.js
-- ============================================================

INSERT INTO public.lessons (title, description, trail, trail_order, content_json, total_steps)
VALUES (
  'A Torre — Movimento e Captura',
  ...
  '{
    "sections": [
      ...
      },
      {
        ...
        "fen": "8/8/8/8/3b4/8/3P4/R7 w - - 0 1",
        "expected_moves": ["a1d1"],
        "orientation": "white",
