...
description: Regras visuais vinculantes do Recruta 64. Use SEMPRE que for criar, redesenhar, estilizar ou revisar qualquer interface deste projeto — tela, componente, layout, cor, tipografia, animação, estado de vazio/erro, ou texto de UI. Também ao trazer tela gerada por v0.app/Gemini para o código.
---

# Design do Recruta 64
...
1. **A escada de patentes só significa patente.** As seis cores vêm de
   `scripts/avatar/patentes.ts` (fonte única, medida por
   `npm run verify:paleta-patentes`): Soldado `#78833B` · Aspirante `#384966` ·
   Capitão `#3E8C81` · Comandante `#3A55B5` · General `#7A3168` · Mestre
...
9. **A direção é "Continuidade"** (decidida em 2026-07-31): navy `#0F1A2E` de
   ...
   **Duas direções foram construídas, vistas e descartadas** — não as proponha de
   ...
   temas para manter). O `#000000` pertence à arte do avatar, **não à interface**.
