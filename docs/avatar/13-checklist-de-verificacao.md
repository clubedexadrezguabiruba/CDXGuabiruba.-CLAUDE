...
- [ ] — ausente: a implementação do ranking de turma **ignora `ranking_visible` deliberadamente**, como declara o comentário em `20260316100000_phase10_rankings.sql:232` e repete a implementação em `20260316100000_phase10_rankings.sql:277-284`. O requisito de opt-out e a implementação discordam; falta decidir qual vence.
